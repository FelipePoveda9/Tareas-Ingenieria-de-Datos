...
select * from mascota;
/*Sentencia DDL*/
Update mascota set nombre='Roky' where codigo= "M001";
select * from vacuna;
Update vacuna set nombre= "Leptospirosis", enfermedad_que_trata ="Leptospirosis" where codigo= "V001" or codigo = "V004";

describe cliente;
CREATE VIEW vista_cliente_mascota AS
SELECT c.primer_nombre, m.nombre AS nombre_mascota FROM cliente c JOIN mascota m ON c.cedula IN (m.cedula_cliente);
SELECT * FROM vista_cliente_mascota;
